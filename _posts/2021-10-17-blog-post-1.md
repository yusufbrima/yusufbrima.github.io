...
We should also note that if the right hand side vanishes, the differential equation is then termed to as \textbf{homogeneous}, otherwise it is \textbf{non-homogeneous}.\\
