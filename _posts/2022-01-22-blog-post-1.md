...
<figure id="east_africa">
    <img src="http://yusufbrima.github.io/images/vibration.gif" style="height:620px;width:650px;"
         alt="A simple vibration of a physical system in a natual frequency">
    <figcaption>A simple vibration of a physical system in a natual frequency (Source: PlainEnglish.io)</figcaption>
</figure>
